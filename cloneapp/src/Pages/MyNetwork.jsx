...
const MyNetwork = ({ user = {} }) => {
  const defaultUser = {
    ...
    name: "Guest User",
    headline: "Welcome to LinkedIn",
  };
  const currentUser = { ...defaultUser, ...user };

  const suggestedUsers = [
    { id: 1, name: "Alice Johnson", job: "Software Engineer" },
    { id: 2, name: "Bob Smith", job: "Product Manager" },
    { id: 3, name: "Charlie Brown", job: "UX Designer" },
  ];
